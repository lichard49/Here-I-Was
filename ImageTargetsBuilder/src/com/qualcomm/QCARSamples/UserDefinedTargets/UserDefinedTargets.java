...
package com.qualcomm.QCARSamples.UserDefinedTargets;
...
public class UserDefinedTargets extends Activity
{
    ...
    private static final String NATIVE_LIB_SAMPLE = "UserDefinedTargets";
    ...
    // Our renderer:
    private UserDefinedTargetsRenderer mRenderer;
    ...
    private native void initRefFreeNative(UserDefinedTargets self);
    ...
    private native boolean startUserDefinedTargets();

    private native boolean stopUserDefinedTargets();

    /** Checks if UserDefiniedTargets is running */
    private native boolean isUserDefinedTargetsRunning();
    ...
    {
        private final WeakReference<UserDefinedTargets> mUserDefTarget;

        LoadingDialogHandler(UserDefinedTargets userDefTarget)
        {
            mUserDefTarget = new WeakReference<UserDefinedTargets>(
                    userDefTarget);
        }

        public void handleMessage(Message msg)
        {
            UserDefinedTargets userDefTarget = mUserDefTarget.get();
    ...
    private class InitQCARTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(UserDefinedTargets.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(
                        UserDefinedTargets.this).create();
    ...
    {
        DebugLog.LOGD("UserDefinedTargets::onCreate");
    ...
    {
        DebugLog.LOGD("UserDefinedTargets::onResume");
        super.onResume();
    ...
    {
        DebugLog.LOGD("UserDefinedTargets::onPause");
        super.onPause();
    ...
    {
        DebugLog.LOGD("UserDefinedTargets::onDestroy");
        super.onDestroy();
     ...
     * access by UserDefinedTargets::onResume() and
    ...
    {
        DebugLog.LOGD("UserDefinedTargets::onConfigurationChanged");
    ...
    public void updateRenderView()
    {
        ...
        if (currentScreenRotation != mLastScreenRotation)
        {
            ...
            {
                DebugLog.LOGD("UserDefinedTargets::updateRenderView");
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer = new UserDefinedTargetsRenderer();
