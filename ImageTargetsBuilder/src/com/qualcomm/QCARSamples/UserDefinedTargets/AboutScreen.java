...
@brief
    About Screen Activity for the UserDefinedTargets sample application
...
public class AboutScreen extends Activity implements OnClickListener
{
    ...
    /** Starts the UserDefinedTargets main activity */
    private void startARActivity()
    {
        Intent i = new Intent(this, UserDefinedTargets.class);
        startActivity(i);
    }
